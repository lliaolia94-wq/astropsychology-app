...
from routers import astrology_router, contacts_router, ai_router, context_router, general_router, users_router, auth_router, natal_chart_router
try:
    from routers import geocoding_router
except ImportError:
    geocoding_router = None
try:
    from routers import guest_router
except ImportError:
    guest_router = None
